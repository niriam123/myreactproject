        ...
        <div className="columns">
          <div className="column is-4-widescreen">
            <div className="sticky-content" ref={sectionRef}>
              ...
              <div>
                <a className="a-link" href="" style={{ color: pcolor }}>
                  DISCOVER OUR SERIES
          ...
          <div className="column is-5-widescreen is-offset-1">
            <motion.p
              ...
              style={{ color: pcolor }}
            >
              Kromin allows its clients to bring ambitious projects to life. Starting from Data Analysis we shape
              Marketing Strategies and Digital Products, enriched by our Contents Media. We talk about numbers and
              results, our services are just the tip of the iceberg. The proactivity of our approach facilitates
              teamwork with our clients, making us proud of what we do.
            </motion.p>
            <motion.div
              ref={ref}
              initial={{ opacity: 0, y: 200 }}
            ...
            >
              ...
              <p className="padding-bottom-60" style={{ color: pcolor }}>
                Data, experience and innovation inspire our approach. We focus on innovation, researching new digital
                technologies to deliver new solutions and services.
              </p>
            </motion.div>
            <motion.div
              ref={ref}
            ...
            >
              ...
              <p className="padding-bottom-60" style={{ color: pcolor }}>
                We have a solid network of digital players who, like us, believe in innovation and contribute to the
            ...
            >
              ...
              <p className="padding-bottom-60" style={{ color: pcolor }}>
                Each member of the Team takes part in the Kromin project with his own skills. We love groups of highly
                competent people. Our Corporate Culture makes us a moving machine with focused and strategic choices. We
                ask our clients to get to know the teams working on the project personally, to give a face and a voice
                to each team member working on the project and its goals.
              </p>
            </motion.div>
          </div>
        </div>
