        ...
        <div className="container container-padding ">
            <div className="columns is-vcentered">
                <div className="column is-6-widescreen">
                    <h3 className='white-color'>Do you have a challenge for us?</h3>
                    <p className='white-color'>Let's create new opportunities together:</p>
                    <p className='white-color'>tell us about your vision.</p>
                </div>
                <div className="column is-6-widescreen is-display-flex is-justify-content-flex-end">
                    <a href=''>
                      <button className='white-btn contact-us-btn'>Contact Us
