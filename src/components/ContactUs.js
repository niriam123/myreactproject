        ...
        <div className="container container-padding ">
            <div className="columns is-vcentered">
                <div className="column is-6-widescreen">
                    <h3 className='white-color padding-bottom-10'>Do you have a challenge for us?</h3>
                    <p className='small white-color'>Let's create new opportunities together:</p>
                    <p className='small white-color'>tell us about your vision.</p>
                </div>
